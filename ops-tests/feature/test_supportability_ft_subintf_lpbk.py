...
information for loopback and sub-interface. The "show tech loopback"
...
def diag_dump_subintf(dut, step):
    """
    Test case to verify the "diag-dump subinterface basic" information with
    ...
    with dut.libs.vtysh.ConfigInterface('13.10') as ctx:
        ctx.no_shutdown()
    out = dut("diag-dump subinterface basic")
...
def test_portd_events(topology, step):
    ...
    step("Test for the \"show tech loopback\" information for loopback"
         "interface")
