...
#define VLOG_LOG_DEST_ALL        "Configure all log level for feature or daemon\n"
#define VLOG_LOG_LEVEL_EMER      "Configure to send emer logs to specifieddestination\n"
...
#define VLOG_LOG_LEVEL_ALL       "Configure to sets the log level for feature or daemon to dbg\n"
#define VLOG_LOG_LEVEL_OFF       "Configure to disables logging to specified destination\n"
