...
def noCoreDumps(dut01Obj):
    ...
    LogOutput('info', str(returnData['buffer']))
    if ("No core dump present in the system"
       not in returnData['buffer']):
        return False
    return True
...
def daemonCoreDumpsPresent(dut01Obj):
    ...
    LogOutput('info', str(returnData['buffer']))
    if ("Total number of core dumps present in the system : 2"
       not in returnData['buffer']):
        return False
...
def kernelCoreDumpsPresent(dut01Obj):
    ...
    LogOutput('info', str(returnData['buffer']))
    if ("Total number of core dumps present in the system : 1"
       not in returnData['buffer']):
        return False
...
def bothCoreDumpsPresent(dut01Obj):
    ...
    LogOutput('info', str(returnData['buffer']))
    if ("Total number of core dumps present in the system : 3"
       not in returnData['buffer']):
        return False
...
def corruptedCoreDumps(dut01Obj):
    ...
    LogOutput('info', str(returnData['buffer']))
    if ("Total number of core dumps present in the system : 5"
       not in returnData['buffer']):
        return False
