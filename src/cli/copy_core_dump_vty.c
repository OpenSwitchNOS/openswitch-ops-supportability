      ...
      const char* destination_file )
{
    ...
    */
    ...
    rc = get_file_list( conf_file, type, &globbuf, gb_pattern ,
...
DEFUN_NOLOCK (cli_platform_copy_core_dump_tftp_inst,
        ...
        "copy core-dump DAEMON_NAME INSTANCE_ID tftp (A.B.C.D | WORD) [FILE_NAME]",
        COPY_STR
        CORE_DUMP_STR
        DAEMON_NAME_STR
        INSTANCE_ID_STR
...
DEFUN_NOLOCK (cli_platform_copy_core_dump_sftp_inst,
        ...
        "copy core-dump DAEMON_NAME INSTANCE_ID sftp USERNAME (A.B.C.D | WORD)"
        " [FILE_NAME]",
        COPY_STR
        CORE_DUMP_STR
        DAEMON_NAME_STR
