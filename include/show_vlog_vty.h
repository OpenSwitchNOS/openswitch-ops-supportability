...
#define SHOW_VLOG_CONFIG_STR     "Displays feature or daemon vlog configuration\n"
#define SHOW_VLOG_NAME           "Enter feature or ops-daemon name\n"
#define SHOW_VLOG_LIST_FEATURE   "List of vlog supported features\n"
#define SHOW_VLOG_FEATURE        "Displays feature specific vlog configurations\n"
#define SHOW_VLOG_DAEMON         "Displays ops-daemon specific vlog configurations\n"
#define SHOW_VLOG_FILTER_SEV     "Filter based on vlog severity level\n"
#define SHOW_VLOG_FILTER_DAEMON  "Filter based on ops-daemon name\n"
