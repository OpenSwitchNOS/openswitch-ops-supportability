...
#define PACKET_SENT "Packets sent\n"
#define PACKET_RECV "Packets received\n"
#define DETAIL_INFO "Detail information\n"
#define OSPFv2_ISM "OSPFv2 Interface State Machine\n"
#define ISM_STAT_INFO "ISM Status Information\n"
#define ISM_EVT_INFO  "ISM Event Information\n"
#define ISM_TIMER_INFO "ISM TImer Information\n"
#define OSPFv2_NSM "OSPF Neighbor State Machine\n"
#define NSM_STAT_INFO       "NSM Status Information\n"
#define NSM_EVT_INFO        "NSM Event Information\n"
#define NSM_TIMER_INFO      "NSM Timer Information\n"
#define OSPF_LSA  "OSPF Link State Advertisement\n"
#define LSA_GEN       "LSA Generation\n"
#define LSA_FLOOD     "LSA Flooding\n"
#define LSA_INST      "LSA Install/Delete\n"
#define LSA_REF       "LSA Refresh\n"
