...
def checkVlogConfigFeature(dut01Obj):
    ...
    returnDevInt = dut01Obj.DeviceInteract(
     command="show vlog feature lacp")
...
def checkVlogConfigDaemon(dut01Obj):
    ...
    returnDevInt = dut01Obj.DeviceInteract(
     command="show vlog daemon ops-lacpd")
...
# simply@#$*beland
    returnDevInt = dut01Obj.DeviceInteract(
        command="show vlog daemon adsf@f$*ASDfjaklsdf@#Q@3r")
...
def checkInvalidFeature(dut01Obj):
    ...
    returnDevInt = dut01Obj.DeviceInteract(
        command="show vlog feature adsf@f$*ASDfjaklsdf@#Q@3r")
...
def checkInvalidSubCommand(dut01Obj):
    ...
    returnDevInt = dut01Obj.DeviceInteract(
        command="show vlog adsf@f$*ASDfjaklsdf@#Q@3r")
