...
#define MAX_SEVS  8
#define SEVERITY_LEVEL_EMER   "Display logs with severity emer\n"
#define SEVERITY_LEVEL_ALERT  "Display logs with severity alert and above\n"
#define SEVERITY_LEVEL_CRIT   "Display logs with severity crit and above\n"
#define SEVERITY_LEVEL_ERR    "Display logs with severity err and above\n"
#define SEVERITY_LEVEL_WARN   "Display logs with severity warn and above\n"
